...
class BatchedFindTarget:
    ...
    # Class labels for each ground-truth box (for multi-class training)
    # in both packed and padded representations
    labels: Optional[MyTensor] = None
    labels__type = torch.long
    labels_padded: Optional[MyTensor] = None
    labels_padded__type = torch.long
